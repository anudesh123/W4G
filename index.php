<!DOCTYPE html>
       ...
       <style>
           ...
           .jumbotron{
            ...
            .cont{
                ...
                margin-top: -20px;
                text-align: center;
                background-color: rgb(200, 54, 05);
            }
    ...
    <body>
        <div class="jumbotron text-center"><h1 style="color: white;">**Olive Restaurant** </h1></div>
       
        <div class="cont">
            <h1><b>--Select The Menu Item To See Its Detail--</b></h1>
          </div>
        ...
        <footer>
            <!-- <div class="footer1">
                <div class="container-fluid"> -->
                    ...
                    <a href="mailto:Anadesh@mitaoe.ac.in">Anadesh@mitaoe.ac.in</a></p>
                    <!-- </div>
              </div> -->
        </footer>
